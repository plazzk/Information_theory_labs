...
public partial class MainForm : Form
{
    ...
    {
        int cursorPosition = RegisterTextBox.SelectionStart;
        string originalText = RegisterTextBox.Text;
        ...
        if (filteredText != originalText)
        {
            ...
            RegisterTextBox.SelectionStart = Math.Max(0, cursorPosition - (originalText.Length - filteredText.Length));
        }

        int validCharsCount = RegisterTextBox.Text.Length;
        LengthLabel.Text = $@"Длина введенных состояний: {validCharsCount}";

        if (validCharsCount != 29)
        {
            RegisterTextBox.BackColor = System.Drawing.Color.LightCoral;
        }
        else
        {
            RegisterTextBox.BackColor = System.Drawing.Color.White;
        }
    }
